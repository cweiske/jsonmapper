...
class JsonMapper
{
    ...
    public function map($json, $object)
    {
        ...
        foreach ($json as $key => $jvalue) {
            ...
            if ($array !== null) {
                ...
                $child = $this->mapArray($jvalue, $array, $strNs, $subtype);
     ...
     */
    public function mapArray($json, $array, $strNs, $class = null)
    {
        foreach ($json as $key => $jvalue) {
            $key = $this->getSafeName($key);
            if ($class === null) {
